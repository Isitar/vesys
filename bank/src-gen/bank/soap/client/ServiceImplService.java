 ...
 * 
 */
@WebServiceClient(name = "ServiceImplService", targetNamespace = "http://soap.bank/", wsdlLocation = "http://localhost:9000/hs?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:9000/hs?wsdl");
